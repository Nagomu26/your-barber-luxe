          ...
          <div className="lg:col-span-7">
            ...
            <Reveal delay={160}>
              <p className="mt-7 max-w-xl text-lg leading-relaxed text-fog sm:text-xl">
                Barbería de confianza en tu barrio. Elige tu hora, entra, siéntate y
                sal como quieres verte.
              </p>
            </Reveal>
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden border border-line bg-panel">
                <img
                  ...
                  alt="Barbero trabajando un corte"
              ...
              <p className="mt-4 font-display text-sm italic text-fog">
                Precisión al milímetro, de un oficio que nunca pasa de moda.
              </p>
            </div>
          </Reveal>
        </div>
