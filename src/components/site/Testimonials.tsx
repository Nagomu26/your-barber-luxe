...
const TESTIMONIOS = [
  {
    texto: "El mejor corte de toda la zona. Mi barbero de confianza desde el primer día.",
    autor: "Carlos M.",
  },
  {
    texto: "Puntual, cercano y un trato impecable. No cambio esta barbería por nada.",
    autor: "Antonio R.",
  },
  {
